    ...
    const filtered = lectures.filter((lec) => {
      return (
        ...
        (!filters.attendanceStatus ||
          lec.attendanceStatus === filters.attendanceStatus)
      );
    });
          ...
          <tbody>
            {filteredLectures.map((lecture, index) => (
              <tr key={lecture.id}>
                ...
                <td>
                  <span
                    className={`status-badge ${lecture.attendanceStatus === "Attended" ? "attended" : "not-attended"}`}
                  >
                ...
                <td className="action-cell">
                  <div className="dropdown-container">
                    <button
                      onClick={() =>
                        setOpenDropdownId(
                          openDropdownId === lecture.id ? null : lecture.id,
                        )
                      }
                    ...
                    {openDropdownId === lecture.id && (
                      <div className="dropdown-menu">
                        <div
                          onClick={() =>
                            handleAttendanceToggle(lecture.id, "Attended")
                          }
                        >
                          Attended
                        </div>
                        <div
                          onClick={() =>
                            handleAttendanceToggle(lecture.id, "Not Attended")
                          }
                        >
                          Not Attended
                        </div>
